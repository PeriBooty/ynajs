...
module.exports = function (str) {
    ...
    arr.forEach(letter => {
        ...
        if (letter === control.data.start || letter === control.data.delimiter) {
            if (stack === 0) {
                console.log("AAAAAAAAA",currentString);
                const currentStruct = _this.parseString(currentString.substr(0,currentString.length));
